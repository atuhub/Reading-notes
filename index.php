...
<meta name="keywords" content="关键词 自行添加">
...
<header id="header">
<div class="logo">
	<a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_directory'); ?>/logo.png"/>
            <!--<?php bloginfo('name'); ?>此处注释掉的为博客名称--></a>
...
<?php } else { ?>
		<img src="<?php bloginfo('template_directory'); ?>/img.php"/></li>
<?php }  ?>
</section>	
...
<div class="copyright"><a target="_blank" href="http://jianbi.me">Theme by iceking</a>·<a target="_blank" href="#">友情链接</a>　</div>
</section>
